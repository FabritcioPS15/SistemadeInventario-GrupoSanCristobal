...
import { Building2, Calendar, MapPin, User, Clock, Search, Plus, Edit, Trash2, Eye, X, AlertTriangle, CheckCircle, FileText, Send } from 'lucide-react';
  ...
  return (
    <div className="w-full px-4 py-8">
      <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-6 mb-10 pb-6 border-b border-gray-200">
        <div>
          <h2 className="text-2xl font-bold text-slate-900 tracking-tight mb-1 uppercase">Visitas de Sutran</h2>
          <p className="text-slate-500 text-sm font-medium">Gestión y seguimiento institucional de inspecciones reglamentarias</p>
        </div>
