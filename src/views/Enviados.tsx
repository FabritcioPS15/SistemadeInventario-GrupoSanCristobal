...
import { Plus, Search, Edit, Trash2, Eye, Send, MapPin, Package, Calendar, User, Truck, X } from 'lucide-react';
        ...
        <div>
          <h2 className="text-2xl font-bold text-gray-900 mb-2">
            ...
            {locationFilter === 'sent-lima' && (
              <span className="ml-2 text-sm font-normal text-blue-600">(Lima)</span>
            )}
            {locationFilter === 'sent-provincias' && (
              <span className="ml-2 text-sm font-normal text-blue-600">(Provincias)</span>
            )}
          </h2>
