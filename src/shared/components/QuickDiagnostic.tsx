    ...
    <div className="p-8">
      <div className="mb-6">
        <div className="flex items-center justify-between">
          <div>
            <h2 className="text-2xl font-normal text-gray-900">Diagnóstico Rápido</h2>
      ...
      <div className="mb-6 p-4 bg-blue-50 border border-blue-200 rounded-lg">
        <div className="flex items-center gap-2 mb-2">
          ...
          <h3 className="font-normal text-blue-900">Resumen</h3>
        </div>
      ...
      {!hasData && (
        <div className="mt-6 bg-yellow-50 border border-yellow-200 rounded-lg p-4">
          <h3 className="font-normal text-yellow-900 mb-2">Instrucciones</h3>
      ...
      {hasData && (
        <div className="mt-6 bg-green-50 border border-green-200 rounded-lg p-4">
          <h3 className="font-normal text-green-900 mb-2">✅ Sistema Listo</h3>
